...
<head>
	...
	<link rel="stylesheet" href="LATEST DEALS.css">
...
<body>
	...
	<nav>
		...
		<a class="active" href="LATEST DEALS.jsp">LATEST DEALS</a>
		...
		<div class="PageContent">
			...
			<%
				...
				try {
					...
					String query = "Select * from SHOES where  LAUNCH_DATE > '" + formatter.format(cal.getTime()) + "'  order by LAUNCH_DATE desc";
