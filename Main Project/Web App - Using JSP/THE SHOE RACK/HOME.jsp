...
<body>
		...
		<div class="account">
			...
			<div class="account-dropDown-content">
				<% if (session.getAttribute("userID") == null) {%>
					<a href="SIGN IN.jsp" style=>SIGN IN</a>
	...
	<div class="content">
		...
		<div class="PageContent">
			<div class="PCHeading">
				<h2>Welcome to THE SHOE RACK</h2>
				<p>We bring you the best of shoes</p>
			</div>
			
			<div class="PCFixedContent">
				<div class="IMAGE">
					<img src="PCFI1.jpg">
				</div>
				...
				<div class="TEXT">
					<p>
						<li>Get the latest and trending shoes at THE SHOE RACK at a discounted rate.</li> <br> <br>
						<li>You can go to SUGGESTIONS to see the best fit for your likings. The LATEST DEALS section brings you the Latest Sales with big discounts and a huge variety of trending shoes.</li> <br> <br>
						<li>In case get stuck with anything , you can always contact us either by E-mail or by submitting your queries under the Contact Us section.</li>
					</p>
				</div>
			</div>
